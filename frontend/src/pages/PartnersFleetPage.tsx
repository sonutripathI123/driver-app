  ...
  const loadData = async () => {
    ...
    let initialVehicles: ExtendedVehicle[] = [
      ...
      },
      {
        ...
        model: 'Q7 Quattro',
        year: 2024,
        registration_plate: 'CROWN-02',
        passenger_capacity: 4,
        luggage_capacity: 4,
        is_active: true,
        image_url: PRESET_VEHICLE_IMAGES[1].url,
      },
      {
        id: 'v-03',
        ...
        model: 'V-Class V300',
        year: 2024,
        registration_plate: 'VIP-VAN-03',
        passenger_capacity: 7,
        luggage_capacity: 7,
        is_active: true,
        image_url: PRESET_VEHICLE_IMAGES[2].url,
      },
    ];
